...
#ifdef RTMP_MAC_USB
#ifdef INF_AMAZON_SE
#define AP_PROFILE_PATH			"/ramdisk/etc/Wireless/RT2870AP/RT2870AP.txt"
#define AP_RTMP_FIRMWARE_FILE_NAME	"/ramdisk/etc/Wireless/RT2870AP/RT2870AP.bin"
#else
#define AP_PROFILE_PATH			"/etc/Wireless/RT2870AP/RT2870AP.txt"
...
#define CARD_INFO_PATH			"/etc/Wireless/RT2870AP/RT2870APCard.txt"
#endif /* MULTIPLE_CARD_SUPPORT */
#endif /* RTMP_MAC_USB */
#endif /* CONFIG_AP_SUPPORT */

#ifdef SINGLE_SKU_V2
#define SINGLE_SKU_TABLE_FILE_NAME	"/etc/Wireless/RT2870STA/SingleSKU.txt"
#endif /* SINGLE_SKU_V2 */
